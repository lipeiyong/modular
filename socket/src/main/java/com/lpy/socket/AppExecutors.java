...
public class AppExecutors {
    ...
    private static ScheduledExecutorService scheduledThreadPoolExecutor() {
        return new ScheduledThreadPoolExecutor(SCHEDULED_CORE_POOL_SIZE, r -> new Thread(r, "scheduled_executor"), (r, executor) -> Log.e(TAG, "rejectedExecution: scheduled executor queue overflow"));
    }
    ...
    private static ExecutorService networkExecutor() {
        return new ThreadPoolExecutor(3, 8, 1000, TimeUnit.MILLISECONDS, new LinkedBlockingQueue<>(8), r -> new Thread(r, "network_executor"), (r, executor) -> Log.e(TAG, "rejectedExecution: network executor queue overflow"));
    }
    ...
    private static class MainScheduledExecutorService implements ScheduledExecutorService {
        ...
        private final Handler mainThreadHandler = new Handler(Looper.getMainLooper());
        private ScheduledExecutorService scheduledExecutorService = new ScheduledThreadPoolExecutor(1, r -> new Thread(r, "scheduled_executor"), (r, executor) -> Log.e(TAG, "rejectedExecution: scheduled executor queue overflow"));
